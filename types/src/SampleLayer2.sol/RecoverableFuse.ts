...
export interface RecoverableFuseInterface extends utils.Interface {
  functions: {
...
export interface RecoverableFuse extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: RecoverableFuseInterface;
